...
@Component({
    selector: 'jhi-team-tc',
    templateUrl: './team-tc.component.html'
})
export class TeamTcComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/team-tc'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: TeamTc) {
        return item.id;
    }
