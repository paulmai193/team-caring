...
public class SocialService {
    ...
    public UserDTO createSocialUser(Connection<?> connection) {
        return this.createSocialUser(connection, "vi");
    }
    
    public UserDTO createSocialUser(Connection<?> connection, String langKey) {
        if (connection == null) {
    ...
    private User createUserIfNotExist(UserProfile userProfile, String langKey, String providerId, String imageUrl) {
        ...
        String encryptedPassword = null; //passwordEncoder.encode(RandomStringUtils.random(10)); --- Set password NULL in case of login throw social connector
