...
@Injectable()
export class NotificationTcPopupService {
    ...
    open(component: Component, id?: number | any): Promise<NgbModalRef> {
        return new Promise<NgbModalRef>((resolve, reject) => {
            ...
            if (id) {
                ...
                setTimeout(() => {
                    this.ngbModalRef = this.notificationModalRef(component, new NotificationTc());
                    resolve(this.ngbModalRef);
                }, 0);
            }
        });
    ...
    notificationModalRef(component: Component, notification: NotificationTc): NgbModalRef {
