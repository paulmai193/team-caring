...
@Component({
    selector: 'jhi-note-tc',
    templateUrl: './note-tc.component.html'
})
export class NoteTcComponent implements OnInit, OnDestroy {
...
currentAccount: any;
    ...
    transition() {
        this.router.navigate(['/note-tc'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: NoteTc) {
        return item.id;
    }
