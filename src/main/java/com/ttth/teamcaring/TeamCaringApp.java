...
@EnableFeignClients
public class TeamCaringApp {

    /** The Constant log. */
    private static final Logger log = LoggerFactory.getLogger(TeamCaringApp.class);

    /** The env. */
    private final Environment   env;

    /**
     * Instantiates a new team caring app.
     *
     * @param env
     *        the env
     */
    public TeamCaringApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes teamCaring.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(TeamCaringApp.class);
