...
public class AccountResource {
    ...
    /**
     * POST /update-profile : Update basic profile information (full name,
     * nickname, push token) and anonymous group information for the CURRENT
     * user. (get by current JWT)
     *
     * @param profileDTO
    ...
    public ProfileDTO updateProfile(@Valid @RequestBody ProfileDTO profileDTO) {
        ...
        return this.customUserService.updateUserProfile(user.get(), profileDTO);
    }

    /**
     * GET /get-profile : Get basic profile information (full name, nickname,
     * push token) of the CURRENT user. (get by current JWT)
     *
     * @return the login if the user is authenticated
     */
